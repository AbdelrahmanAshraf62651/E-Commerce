...
function showSection(section) {
    [homeSection, featuredSection, shopSection, cartSection, authSection].forEach(s => s.style.display = 'none');
...
navLogin.addEventListener('click', e => { 
    ...
    setupAuthForms(); // Re-setup forms when auth section is shown
});
